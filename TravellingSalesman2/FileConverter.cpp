...
#define     FILE_IN         "/Users/radoslawlodzinski/CLionProjects/TravellingSalesman2/sourcesAsymmetricTSP/ftv170.atsp"         // Nazwa pliku z danymi do przetworzenia
#define     FILE_OUT        "/Users/radoslawlodzinski/CLionProjects/TravellingSalesman2/convertedTSPFiles/tsp_"              // Prefiks nazwy pliku z danymi przetworzonymi
...
//---------------------------------------------------------------------
void FileConverter::error_exit(const string &msg)
{
    cout << msg << endl;
    system("PAUSE");
    exit(1);
...
//---------------------------------------------------------------------
int FileConverter::header_get_size(ifstream &file)
{
    int     header_lines = 0;
    int     size = 0;
    string  line;
...
//---------------------------------------------------------------------
int FileConverter::value_digits(int val)
{
    int width = 0;
